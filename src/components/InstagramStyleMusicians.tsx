  ...
  const musicians = [
    {
      ...
      posts: [
        ...
        },
        {
          ...
          likes: 312,
          comments: 31,
          caption: "Momento mágico no último evento corporativo 🎵",
          location: "São Paulo"
        },
        {
          id: 4,
          ...
          likes: 156,
          comments: 12,
          caption: "Preparando repertório clássico para próximos eventos",
          location: null
        },
        {
          id: 5,
          ...
          likes: 203,
          comments: 19,
          caption: "Violino Stradivarius 1721 - meu companheiro de todas as horas 🎻",
          location: null
        },
        {
          id: 6,
          ...
          likes: 278,
          comments: 27,
          caption: "Cerimônia religiosa hoje. Música sacra toca a alma 🙏✨",
    ...
    },
    {
      ...
      posts: [
        ...
        },
        {
          ...
          likes: 234,
          comments: 22,
          caption: "Masterclass de hoje foi incrível! Obrigada a todos 🎻",
        ...
        },
        {
          ...
          likes: 298,
          comments: 33,
          caption: "Concerto de ontem foi emocionante ✨ #concerto #violin",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-20 animate-fade-in-up">
          ...
          <p className="font-inter text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            Siga nossos músicos e acompanhe seus trabalhos no Instagram. 
            Cada artista compartilha sua paixão pela música através de seus posts.
          </p>
        </div>
          ...
          {musicians.map((musician, index) => (
            <div key={musician.id} className="animate-fade-in-up" style={{ animationDelay: `${index * 0.2}s` }}>
              ...
              <div className="bg-card rounded-lg shadow-card p-6 mb-6">
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-2 mb-1">
                      <h3 className="font-inter font-semibold text-lg text-card-foreground">
                        {musician.handle}
                      </h3>
                      {musician.isVerified && (
                ...
                <div className="mb-6">
                  <p className="font-inter text-sm text-card-foreground whitespace-pre-line leading-relaxed">
                    {musician.bio}
                  </p>
                </div>
                        ...
                        <div key={post.id} className="space-y-4">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                <p className="font-inter font-semibold text-sm text-card-foreground">
                                  {musician.handle}
                                </p>
                                {post.location && (
                          ...
                          <div>
                            ...
                            <p className="font-inter text-sm text-card-foreground">
                              <span className="font-semibold">{musician.handle}</span> {post.caption}
                            </p>
